...
const Signup = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center py-12 px-4" style={{backgroundColor: 'var(--bg-warm)'}}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8" style={{boxShadow: '0 10px 40px rgba(255, 90, 95, 0.15)'}}>
          <h1 className="text-4xl font-bold text-center mb-2" style={{color: 'var(--text-dark)'}}>Join Us</h1>
          <p className="text-center mb-8" style={{color: 'var(--text-light)'}}>Create your account to get started</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="relative">
              <div className="flex items-center">
                <MdPerson className="w-5 h-5 mr-2 mb-2 flex-shrink-0" style={{color: 'var(--coral-primary)'}} />
                <input
                  type="text"
                  name="name"
                  ...
                  disabled={loading}
                  className="block w-full pl-10 mb-3 pr-4 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 transition disabled:bg-gray-100 disabled:cursor-not-allowed"
                  style={{
            ...
            <div className="relative">
              <div className="flex items-center">
                <MdEmail className="w-5 h-5 mr-2 mb-2 flex-shrink-0" style={{color: 'var(--coral-primary)'}} />
                <input
                  type="email"
                  name="email"
                  ...
                  onChange={handleChange}
                  disabled={loading}
                  className="block w-full pl-10 pr-4 mb-3 py-3 border-2 rounded-lg focus:outline-none focus:ring-2 transition disabled:bg-gray-100 disabled:cursor-not-allowed"
                  style={{
                    borderColor: 'var(--border-light)',
                    color: 'var(--text-dark)'
                  }}
            ...
            <div className="relative">
              <div className="flex items-center">
                <MdLock className="w-5 h-5 mr-2 mb-2 flex-shrink-0" style={{color: 'var(--coral-primary)'}} />
                <input
                  type="password"
                  name="password"
                  ...
                  onChange={handleChange}
                  disabled={loading}
                  className="block w-full pl-10 pr-4 py-3 mb-2 border-2 rounded-lg focus:outline-none focus:ring-2 transition disabled:bg-gray-100 disabled:cursor-not-allowed"
                  style={{
