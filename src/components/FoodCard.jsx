...
const FoodCard = ({name, image, id, price, type}) => {
  ...
  return (
    <div className="p-4 w-full sm:w-[18rem] bg-white rounded-xl flex flex-col gap-3 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 hover:-translate-y-1">
      ...
      <div className="text-xl sm:text-2xl font-semibold text-gray-900">{name}</div>
